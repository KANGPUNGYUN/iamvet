...
const hospitalsData: Record<string, HospitalDetailData> = {
  "1": {
    ...
    name: "서울의료원",
    summary:
      "서울 수의학과 최초의 의료 서비스를 제공하는 서울의료원입니다. 최첨단 진료 장비와 모든 동물을 위한 전문 의료진이 대기하고 있습니다.",
          ...
          detailedEvaluations: [
            {
              category: "시설 및 장비",
              comment:
                "최신 장비들이 잘 갖춰져 있고, 시설이 깔끔하게 관리되고 있습니다. 특히 수술실 환경이 인상적이었습니다.",
            },
            {
              category: "직원 전문성",
              comment:
                "수의사 선생님들의 전문성이 뛰어나며, 간호사분들도 경험이 풍부해 보입니다.",
            },
            {
              category: "서비스 품질",
              comment:
                "전반적으로 서비스가 만족스럽고, 응급상황 대응도 신속했습니다.",
            },
          ],
        },
        {
          ...
          detailedEvaluations: [
            {
              category: "시설 및 장비",
              comment:
                "시설은 양호하나 일부 장비의 업데이트가 필요해 보입니다.",
            },
            {
              category: "직원 전문성",
              comment:
                "직원들의 전문성은 우수하지만, 바쁜 시간대에는 대기시간이 다소 길어집니다.",
            },
            {
              category: "서비스 품질",
              comment:
                "기본적인 서비스는 만족스럽지만, 고객 응대에서 개선의 여지가 있습니다.",
            },
          ],
        },
      ],
  ...
  "2": {
    ...
    name: "건국대학교 동물병원",
    summary:
      "건국대학교 수의과대학 부속동물병원으로 교육과 진료를 병행하는 종합동물병원입니다. 최신 의료진과 시설로 반려동물의 건강을 책임집니다.",
    contact: "02-450-3700",
          ...
          detailedEvaluations: [
            {
              category: "시설 및 장비",
              comment:
                "대학병원답게 최첨단 장비와 넓은 시설을 보유하고 있습니다. 특히 MRI, CT 등 고급 진단장비가 인상적입니다.",
            },
            {
              category: "직원 전문성",
              comment:
                "교수진과 전공의들의 전문성이 매우 뛰어나며, 어려운 케이스도 잘 해결해주십니다.",
            },
            {
              category: "서비스 품질",
              comment:
                "교육병원이라 학생들도 많지만, 그만큼 더 세심하게 진료해주시는 느낌입니다.",
            },
          ],
        },
      ],
  ...
  "3": {
    ...
    name: "24시간 응급동물병원",
    summary:
      "24시간 응급진료 전문 동물병원입니다. 야간 응급상황과 중환자 관리에 특화된 의료진과 시설을 갖추고 있습니다.",
          ...
          detailedEvaluations: [
            {
              category: "시설 및 장비",
              comment:
                "응급의료에 특화된 장비들이 잘 구비되어 있고, 중환자실 시설이 체계적으로 운영되고 있습니다.",
            },
            {
              category: "직원 전문성",
              comment:
                "응급상황 대응 능력이 뛰어나고, 신속한 의사결정과 처치가 인상적입니다.",
            },
            {
              category: "서비스 품질",
              comment:
                "응급상황의 특성상 대기시간이 있을 수 있지만, 생명을 다루는 곳답게 최선을 다하고 있습니다.",
            },
          ],
        },
      ],
