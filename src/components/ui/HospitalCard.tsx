...
const HospitalCard: React.FC<HospitalCardProps> = ({ hospital }) => {
  return (
    <Link href={`/hospitals/${hospital.id}`}>
      <div className="relative rounded-[16px] border border-[#EFEFF0] flex flex-col lg:flex-row items-start gap-[20px] lg:gap-[30px] p-[20px] lg:p-[28px] hover:shadow-md transition-shadow duration-200 cursor-pointer">
        {/* 병원 이미지 */}
        ...
        {/* ChevronRightIcon */}
        <div className="absolute top-[20px] right-[20px] lg:relative lg:top-auto lg:right-auto flex items-center justify-center w-8 h-8 flex-shrink-0">
