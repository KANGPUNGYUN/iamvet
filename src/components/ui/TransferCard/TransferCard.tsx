...
const TransferCard: React.FC<TransferCardProps> = ({
  ...
  return (
    <div
      className="w-full bg-transparent shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden cursor-pointer rounded-[8px] border border-[1px] border-[#EFEFF0] flex flex-row"
      style={{
        display: "flex",
        width: "100%",
        height: "130px",
