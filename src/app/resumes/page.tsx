...
export default function ResumesPage() {
  ...
  const { setResumeLike, toggleResumeLike, isResumeLiked, likedResumes } =
    useLikeStore();
          ...
          <div className="max-w-[1440px] mx-auto px-[16px]">
            <div className="hidden xl:flex xl:gap-[30px] xl:py-8">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex justify-between items-center self-stretch">
                  <h1 className="text-[28px] font-title text-[#3B394D]">
                    인재 채용
                  </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {resumeData.map((resume) => (
                    <ResumeCard
                      ...
                      isBookmarked={
                        isStoreInitialized
                          ? likedResumes.has(resume.id)
                          : resume.originalData?.isLiked || false
                      }
            ...
            <div className="xl:hidden py-4">
              <div className="space-y-4">
                {/* 제목과 필터 버튼 */}
                <div className="flex justify-between items-center">
                  <h1 className="font-title text-[28px] text-[#3B394D]">
                    인재 채용
                  </h1>
                  <button
